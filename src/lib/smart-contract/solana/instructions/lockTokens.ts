...
export const lockPlatformTokens = async (
  ...
  const lockTokensInstrcution = await syphonLockProgram.methods
    .lockTokens(lock_type, amount)
    .accounts({
    ...
    .instruction();
  TxIns.push(lockTokensInstrcution);
